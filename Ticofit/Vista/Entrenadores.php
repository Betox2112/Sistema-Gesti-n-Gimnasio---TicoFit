...
$stmt = $conn->conn->prepare("SELECT id, nombre, especialidad, email FROM entrenadores");
$stmt->execute();
...
<head>
    ...
    <title>Entrenadores - Ticofit</title>
    ...
    <?php else: ?>
        <table class="table table-striped table-bordered">
            ...
            <?php foreach ($entrenadores as $entrenador): ?>
                <tr>
                    <td><?php echo htmlspecialchars($entrenador['id']); ?></td>
                    <td><?php echo htmlspecialchars($entrenador['nombre']); ?></td>
                    <td><?php echo htmlspecialchars($entrenador['especialidad'] ?: 'N/A'); ?></td>
                    <td><?php echo htmlspecialchars($entrenador['email'] ?: 'N/A'); ?></td>
                </tr>
            <?php endforeach; ?>
            </tbody>
        </table>
